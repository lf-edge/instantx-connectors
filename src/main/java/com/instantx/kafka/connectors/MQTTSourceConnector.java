...
/**
 * Implementation of a MQTT Source connector (with specific custom adaptations to STEP project)
 */
public class MQTTSourceConnector extends SourceConnector {
  ...
  public List<Map<String, String>> taskConfigs(int maxTasks) {
    ...
    //## Define taskConfigs based on number of worker nodes and create a distinct name for each!!!
    //## different name | consumer | group ...

    // if (maxTasks > 1) { log.info("maxTasks is " + maxTasks + ". MaxTasks > 1 is not supported in this connector."); }
