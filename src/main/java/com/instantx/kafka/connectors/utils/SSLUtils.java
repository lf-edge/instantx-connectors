...
public class SSLUtils {
    ...
    /*
     * public static SSLSocketFactory getSocketFactory(final String caCrtFile, final
     * String crtFile, final String keyFile, final String password) throws Exception
     * {
     * 
     ...
     * key = converter.getKeyPair(((PEMEncryptedKeyPair)
